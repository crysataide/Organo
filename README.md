# Projeto Página de Colaboradores - Organo
...
Posicionado no diretório do projeto é só executar o seguinte comando:

### `npm start`

Executa o aplicativo no modo de desenvolvimento.\
Caso a página não abra automaticamente, basta acessar [http://localhost:3000](http://localhost:3000) para visualizá-lo em seu navegador.
